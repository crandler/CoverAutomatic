...
const I18N = {
  ...
  de: {
    ...
    settings_comfort_hint: "Definiert den Komfortbereich. Unter min = Heizmodus (Beschattung deaktiviert, Sonnenwärme nutzen). Über max = Kühlmodus (Beschattung aktiv). Dazwischen = Neutral (Beschattung aktiv zur Prävention).",
