...
const I18N = {
  en: {
    ...
    cond_temperature_above: "Temperature above",
    cond_temperature_below: "Temperature below",
  ...
  de: {
    ...
    cond_temperature_above: "Temperatur über",
    cond_temperature_below: "Temperatur unter",
